...
<head>
 ...
 <title>Aliff</title>
  ...
  <meta name="keywords" content="Laravel, Laravel Developer, Aliff, Rosli, Aliff Rosli,Muhammad Aliff Bin Rosli , Aliff Rosli Laravel Developer, Kedah, 
  Selangor, PHP, Trainer Laravel, Laravel 8, Lamp Stack, Git workflow, Stack, Looka, Software Engineer">  
 <meta name="viewport" content="width=device-width, initial-scale=1.0" />
 <meta name="google-site-verification" content="0cA3VTdQH8c8XHkxMU5ESLjkz3Un6Imuu2yB_Sh1-jg" />
		...
		<div class="container mx-auto flex flex-col md:flex-row items-center my-12 md:my-24">
			...
			<div class="p-8 mt-12 mb-6 md:mb-0 md:mt-0 ml-0 md:ml-12 lg:w-2/3  justify-center">
				<div class="h-8 flex flex-wrap content-center">
                    <div>
                        <img class="inline-block mt-24 md:mt-0 p-8 md:p-0 "  src="{!! asset('image/1.png') !!}">
                    </div>
				</div>
			</div>
            ...
            <div>
                ...
                <div class="flex flex-wrap justify-center gap-2">
                  ...
                  <a href="tel:+60135162634" class="bg-yellow-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
