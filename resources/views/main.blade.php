...
<head>
 ...
 <link rel="icon" href="{{ url('image/me-modified.png') }}">
...
<link rel="stylesheet" href="https://demos.creative-tim.com/notus-js/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css">
    <section class="bg-auto pt-12 bg-transparent">
        <div class="items-center flex flex-wrap">
        <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
            <img class="max-w-full rounded-lg" src="image/me-modified.png">
        </div>
        <div class="w-full md:w-5/12 ml-auto mr-auto px-4">
            <div class="md:pr-12">
            <div class="flex flex-wrap justify-center gap-2">
                <div class="text-black-600 text-center flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-blue-300 mt-8">
                    <i class="fab fa-dev text-xl text-center"></i>
                </div>
            </div>
            <h3 class="text-3xl font-bold">MUHAMMAD ALIFF BIN ROSLI</h3>
            ...
            <ul class="list-none mt-6">
                ...
                <div class="flex items-center">
                    <div>
                    <span class="text-xl font-semibold inline-block py-1 px-2 uppercase rounded-full text-black-600 bg-blue-300 mr-3"><i class="fas fa-code text-xl"></i></span>
                    </div>
                    <div>
                ...
                <div class="flex items-center">
                    <div>
                    <span class="text-xl font-semibold inline-block py-1 px-2 uppercase rounded-full text-black-600 bg-blue-300 mr-3"><i class="fab fa-laravel text-xl"></i></span>
                    </div>
                    <div>
                    <h4 class="text-blueGray-500">Laravel</h4>
                    </div>
                </div>
                </li>
                <div class="flex items-center">
                    <div>
                    <span class="text-xl font-semibold inline-block py-1 px-2 uppercase rounded-full text-black-600 bg-blue-300 mr-3"><i class="fab fa-github text-xl"></i></span>
                    </div>
                    <div>
            ...
            <div>
                ...
                <div class="flex flex-wrap justify-center gap-2">
                  ...
                  <a href="https://www.linkedin.com/in/aleprosli/" class="bg-blue-600 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                  ...
                  <a href="https://github.com/aleprosli" class="bg-gray-700 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
                  ...
                  <a href="mailto:aliff.rosli96@gmail.com" class="bg-red-500 p-2 font-semibold text-white inline-flex items-center space-x-2 rounded">
